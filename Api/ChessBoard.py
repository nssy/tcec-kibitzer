...
# Modified by NssY to be compatible with python 3
# Also modified piece promotion code to work with chess engine output
...
class ChessBoard:
    ...
    def _parseTextMove(self,txt):
        ...
        # Capitalize the last piece
        if txt[-1:] in ('q','r','n','b'):
            txt = "".join([txt[:-1], txt[-1:].upper()])
